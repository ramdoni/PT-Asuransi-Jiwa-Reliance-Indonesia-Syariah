        ...
        <div class="card">
            <div class="header pb-0">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <a href="{{route('pengajuan-harian.insert')}}" class="btn btn-info"><i class="fa fa-plus"></i> Pengajuan</a>
                        <span wire:loading>
                        ...
                        <tbody>
                            @foreach ($data as $k => $item)
                                <tr>
                                    ...
                                    <td><a href="{{route('pengajuan-harian.edit',$item->id)}}">{{$item->no_pengajuan_harian}}</a></td>
