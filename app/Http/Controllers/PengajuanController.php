...
class PengajuanController extends Controller
{
    public function printDN(Pengajuan $id)
    {
        ...
        $pdf->loadView('livewire.pengajuan.print-dn',['total_gross'=>$total_gross,'extra_mortalita'=>$extra_mortalita,'total'=>$total,'data'=>$id,'head_teknik'=>$head_teknik,'kontribusi'=>$kontribusi,'extra_kontribusi'=>$extra_kontribusi,'potongan_langsung'=>$id->potongan_langsung]);
