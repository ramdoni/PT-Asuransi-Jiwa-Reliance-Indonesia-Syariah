...
class Index extends Component
{
    ...
    public $selected_id,$filter_keyword,$check_id=[],$filter_polis_id,$is_download=false,$check_all,$polis;
    ...
    public function mount()
    {
        $this->polis = Polis::select('polis.*')
                            ->join('memo_cancel','memo_cancel.polis_id','=','polis.id')
                            ->groupBy('polis.id')
                            ->get();
    }
    ...
    public function downloadExcel()
    {
        ...
        $data = Kepesertaan::where('polis_id',$this->filter_polis_id)->whereIn('memo_cancel_id',$this->check_id)->get();
        $num=10;
